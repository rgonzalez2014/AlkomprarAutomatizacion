@CedulaCiudadania
Feature: Realizar el registro de un pedido con medio de pago Bono con Consignacion
  ...
  Scenario Outline: Crear un pedido con pago Bono sin Consignacion
    ...
    And Se agregan los productos al pedido
      | ean   | cantidad   |
      | <Ean> | <Cantidad> |
    And Se seleccionan las fechas y el medio de pago bono con consignacion
      | bono   | observaciones   |
      | <Bono> | <Observaciones> |
    ...
    Examples:
      ...
      | asesor_roger | 123      | ALKUN       | Si                     | C.C           | 31505117        | Miguel       | Santiago      | Nuñez          | Ruiz            | Bogotá | CL 35 SUR # 78 Q - 29 | Super Manzana 9B - Kennedy | 3214072323 | 6812121 | roger.gonzalez.ext@colcomercio.com.co | Masculino | NO     | C.C             | 1010111186        | Camila         | Ines            | Martinez         | Perez             | Bogotá   | CL 35 SUR # 78 Q - 29 | Super Manzana 9B - Kennedy | 3114997098 | 8056776 | dianatrivi@hotmail.com | Femenino | 7705946463560 | 1        | 3    | test cedula ciudadania |
  ...
  @CedulaExtranjeria
  Scenario Outline: Crear un pedido con pago Bono con Consignacion
    Given Se despliega la pagina CRM Alkomprar y se ingresan las credenciales
      | usuario   | password   |
      | <Usuario> | <Password> |
    When Se ingresa al modulo de Televentas y se hace clic en Crear
