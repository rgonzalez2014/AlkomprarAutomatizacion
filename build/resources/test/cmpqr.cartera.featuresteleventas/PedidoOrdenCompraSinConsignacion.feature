Feature: Realizar el registro de un pedido con medio de pago Orden de Compra sin Consignacion

  @CedulaCiudadania
  Scenario Outline: Crear un pedido con pago Orden de Compra sin consignacion
    ...
    And Se agregan los productos al pedido
      | ean   | cantidad   |
      | <Ean> | <Cantidad> |
    And Se seleccionan las fechas y el medio de pago orden de compra sin consignacion
