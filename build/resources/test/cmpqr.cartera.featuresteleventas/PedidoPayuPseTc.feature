Feature: Realizar el registro de un pedido con medio de pago Payu Pse-Tc

  @CedulaCiudadania
  Scenario Outline: Crear un pedido con pago Payu Pse-Tc
    ...
    And Se agregan los productos al pedido
      | ean   | cantidad   |
      | <Ean> | <Cantidad> |
    And Se seleccionan las fechas y el medio de pago payu Pse-Tc
    ...
    Examples:
      ...
      | asesor_roger | 123      | ALFLO       | Si                     | C.C           | 31505118        | Miguel       | Santiago      | Nuñez          | Ruiz            | Bogotá | CL 35 SUR # 78 Q - 29 | Super Manzana 9B - Kennedy | 3214072323 | 6812121 | roger.gonzalez.ext@colcomercio.com.co | Masculino | NO     | C.C             | 1010111186        | Camila         | Ines            | Martinez         | Perez             | Bogotá   | CL 35 SUR # 78 Q - 29 | Super Manzana 9B - Kennedy | 3114997098 | 8056776 | dianatrivi@hotmail.com | Femenino | 7705946463560 | 1        | 8    | 3        | test cedula ciudadania |
  ...
  Scenario Outline: Crear un pedido con pago Payu Pse-Tc
    ...
    Examples:
      | Usuario        | Password | UnidadVenta | FacturacionElectronica | TipoDocumento | NumeroDocumento | PrimerNombre | SegundoNombre | PrimerApellido | SegundoApellido | Ciudad | Direccion             | Barrio                     | Celular     | Fijo    | Email                                 | Genero    | Habeas | TipoDocumento_2 | NumeroDocumento_2 | PrimerNombre_2 | SegundoNombre_2 | PrimerApellido_2 | SegundoApellido_2 | Ciudad_2 | Direccion_2           | Barrio_2                   | Celular_2  | Fijo_2  | Email_2                | Genero_2 | Ean           | Cantidad | Payu | TipoPago | Observaciones           |
      | asesor_gabriel | 123      | ALFLO       | No                     | C.E           | 031505          | Jose         | Miguel        | Blanco         | Sire            | Bogotá | CL 35 SUR # 78 Q - 29 | Super Manzana 9B - Kennedy | 31044738000 | 5373800 | roger.gonzalez.ext@colcomercio.com.co | Masculino | NO     | C.E             | 25678             | Mary           | Antonia         | Bermudez         | Sanchez           | Bogotá   | CL 35 SUR # 78 Q - 29 | Super Manzana 9B - Kennedy | 3114997098 | 8056776 | dianatrivi@hotmail.com | Femenino | 8801643782634 | 1        | 8    | 3        | test cedula extranjeria |
