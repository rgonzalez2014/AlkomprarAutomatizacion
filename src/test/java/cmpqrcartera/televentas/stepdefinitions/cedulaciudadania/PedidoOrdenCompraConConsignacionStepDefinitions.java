...
public class PedidoOrdenCompraConConsignacionStepDefinitions {
    ...
    @Then("^Se seleccionan las fechas y el medio de pago orden de compra con consignacion$")
    public void se_seleccionan_las_fechas_y_el_medio_de_pago_orden_de_compra_con_consignacion(List<DataTeleventas> listadatos) throws InterruptedException {
